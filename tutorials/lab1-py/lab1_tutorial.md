...
Для выполнения лабораторной работы можно воспользоваться:

- [PyCharm Community / Professional](https://www.jetbrains.com/pycharm/download/)

- [VS Code](https://code.visualstudio.com/)

- Любыми другими редакторами кода

## Создание проекта локально
Если вы используете Pycharm, то можно воспользоваться таким способом, если же другим редактором - создаем проект ручным способом, который описан [ниже](lab1_tutorial.md#создаем-проект-django) 
